...
<div class="tableur">
     ...
     <div>
        <form v-on:submit.prevent="submit($event)">
            ...
            <div v-if="form.USDinput" id="USD">
                ...
                <input type="text" name="coursDollar" placeholder="Cours du Dollar" v-model="form.coursDollar"/>
            </div>
    ...
    <div id="recap">
        <div v-if="deviseUSD === true" class="values">
            ...
            <p><span class="deviseUSD">Taux de change USD : </span>{{form.coursDollar}}</p>
    ...
    methods: {
        submit(e) {
            ...
            if (!this.deviseUSD) {
                ...
                this.investissementTotal = this.form.quantite*this.form.coursActionActuelle //$
                this.investissementTotalApresVente = (this.investissementTotal-this.form.fraisVente) //$
                this.plusValue = (this.investissementTotalApresVente-this.coutTotalAchat)/this.form.coursDollar //€
                console.log(this.plusValue);

                this.value0 = (this.investissementTotalApresVente-(this.plusValue*(0/100))*this.form.coursDollar)/this.form.quantite; //$
                this.value50 = (this.investissementTotalApresVente-(this.plusValue*(50/100))*this.form.coursDollar)/this.form.quantite; //$
                this.value100 = (this.investissementTotalApresVente-(this.plusValue*this.form.coursDollar))/this.form.quantite; //$
                console.log(this.plusValue*this.form.coursDollar);
                console.log(this.plusValue);
            }
        },
    }
